...
const int PLATFORM_COLOR = FG_DARKRED | BACKGROUND_DEFAULT;
const int TERRAIN_COLOR = FG_DARKYELLOW | BG_DARKYELLOW;

const int PLAYER_HEAD_COLOR = FG_WHITE | BACKGROUND_DEFAULT;
const int PLAYER_BODY_COLOR = FG_WHITE | BACKGROUND_DEFAULT;
